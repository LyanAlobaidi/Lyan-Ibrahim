...
def send_message(name, img_name):
    global stoop
    stoop=1
    global engine
    engine = pyttsx3.init()
    ...
    content=name+" arrived to DEWA at " + time.ctime()
        ...
        # check to see if we have found a match
            ...
            #If someone in your dataset is identified, print their name on the screen
                ...
                #Take a picture to send in the email
                    ...
                    engine.runAndWait()
                    request = send_message(name,img_name)
...
while True:
    ...
    if (distance>100):
       ...
       message = input("Press enter to take attendance\n\n") # Run until someone presses enter
